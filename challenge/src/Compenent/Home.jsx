        ...
        <div className="card" key={e.id}>
          <a href={`/details/${e.id}`} onClick={handleClick}>
            ...
            {e.thumb?.length > 0 ? (
              ...
              <img
                src={
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV-5NOMMcpY4wbiYLek64rO8U6bQV8W6b3t7jGkcn70bJDIIX2ZT3mPA7X6ppvCBkLOmo&usqp=CAU"
                }
              />
            )}
            <div className="container">
              <p>
                {e.description ? e.description : "Description not available..."}{" "}
              </p>
            </div>
          </a>
        </div>
